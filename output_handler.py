...
def output_destination_with_route_url(
    ...
    print(f"{station_name} - {get_translation('route')}: ", end="")
...
def print_no_stations_with_rally_found() -> None:
    ...
    print(get_translation("no_stations_with_rally_found"))
